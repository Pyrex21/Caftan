...
const testimonials = [
  {
    name: 'سارة',
    text: 'تجربة رائعة! الفستان تاج من أحلى ما تخيلته. فريق أفراح كوشو متعاون جداً ومحترف.',
    rating: 5,
  },
  {
    name: 'نور',
    text: 'اخترت العمارية الملكية وكان كل شيء أكثر مما تخيلته. شكراً أفراح كوشو على يوم مميز!',
    rating: 5,
  },
  {
    name: 'فاطمة',
